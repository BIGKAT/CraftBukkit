...
public class EntityTypes
{
    ...
    public static Map b = new HashMap(); // Forge - private -> public

    /** Provides a mapping between a string and an entity classes */
    public static Map c = new HashMap(); // Forge - private -> public

    /** provides a mapping between an entityID and an Entity Class */
    public static Map d = new HashMap(); // Forge - private -> public
    ...
    public static HashMap a = new LinkedHashMap(); // Forge - private -> public

    /**
     * adds a mapping between Entity classes and both a string representation and an ID
     */
    public static void a(Class par0Class, String par1Str, int par2) // Forge - private -> public
    {
