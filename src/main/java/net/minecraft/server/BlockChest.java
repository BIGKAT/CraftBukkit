...
//        } else if (world.s(i, j + 1, k)) {
            ...
            return true;
        } else if (world.getTypeId(i - 1, j, k) == this.id && (world.isBlockSolidOnSide(i - 1, j + 1, k, DOWN) || n(world, i - 1, j, k)))
        {
            return true;
        }
        else if (world.getTypeId(i + 1, j, k) == this.id && (world.isBlockSolidOnSide(i + 1, j + 1, k, DOWN) || n(world, i + 1, j, k)))
        ...
        else if (world.getTypeId(i, j, k - 1) == this.id && (world.isBlockSolidOnSide(i, j + 1, k - 1, DOWN) || n(world, i, j, k - 1)))
        {
            return true;
        }
        else if (world.getTypeId(i, j, k + 1) == this.id && (world.isBlockSolidOnSide(i, j + 1, k + 1, DOWN) || n(world, i, j, k + 1)))
