...
//        }
        ...
        do
        {
          ...
          if ((block != null) && (!block.isLeaves((World)world, i, j, k))) //TODO cast to World
          {
            break;
          }
          j--;
            ...
            for (int j1 = j; j1 <= j + 2; ++j1) {
                ...
                for (int i2 = i - l1; i2 <= i + l1; ++i2) {
                    ...
                    for (int k2 = k - l1; k2 <= k + l1; ++k2) {
                        ...
                        if (((Math.abs(j2) != l1) || (Math.abs(l2) != l1) || (random.nextInt(2) != 0)) && ((bl == null) || (bl.canBeReplacedByLeaves((World)world, i2, j1, k2)))) { //TODO cast to World
