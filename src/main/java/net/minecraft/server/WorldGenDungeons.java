    ...
    public boolean a(World world, Random random, int i, int j, int k) {
        ...
        if (j1 >= 1 && j1 <= 5) {
                            ...
                            if (world.isEmpty(i2, j, j2)) {
                                ...
                                if (k2 == 1) {
                                    ...
                                    if (tileentitychest != null) {
                                    	for (int l2 = 0; l2 < DungeonHooks.getDungeonLootTries(); ++l2) {
                                            ItemStack itemstack = DungeonHooks.getRandomDungeonLoot(random); //this.a(random);
            ...
            if (tileentitymobspawner != null) {
            	tileentitymobspawner.setMobID(DungeonHooks.getRandomDungeonMob(random));
            } else {
