...
//                            if (k2 != 0 && k2 != Block.LEAVES.id) {
                            ...
                            if ((bl == null) || (bl.canBeReplacedByLeaves((World)world, i2, l1, j2))) { //TODO cast to World
                                flag = false;
                            }
                        } else {
                            flag = false;
                    ...
                    for (i2 = j + l; i2 >= j + i1; --i2) {
                        for (j2 = i - l2; j2 <= i + l2; ++j2) {
                            ...
                            for (int i3 = k - l2; i3 <= k + l2; ++i3) {
                                ...
                                if (((Math.abs(k2) == l2) && (Math.abs(j3) == l2) && (l2 > 0)) || ((bl != null) && (!bl.canBeReplacedByLeaves((World)world, j2, i2, i3)))) //cast to World
                                	continue;
...
//                        if (j2 == 0 || j2 == Block.LEAVES.id) {
                        ...
                        if ((j2 == 0) || (bl == null) || (bl.isLeaves((World)world, i, j + i2, k))) { //cast to World
