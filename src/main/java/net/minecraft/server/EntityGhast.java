    ...
    protected void be() {
        ...
        if (this.target != null && this.target.e((Entity) this) < d4 * d4) {
            ...
            if (this.l(this.target)) {
                if (this.f == 10) {
                    this.worldObj.a((EntityHuman) null, 1007, (int) this.posX, (int) this.posY, (int) this.posZ, 0);
                }

                ++this.f;
                if (this.f == 20) {
                    this.worldObj.a((EntityHuman) null, 1008, (int) this.posX, (int) this.posY, (int) this.posZ, 0);
