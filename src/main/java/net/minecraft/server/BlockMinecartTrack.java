...
public class BlockMinecartTrack extends Block {
    ...
    public void doPhysics(World world, int i, int j, int k, int l) {
        if (!world.isStatic) {
            ...
            boolean flag = false;
            if (!world.isBlockSolidOnSide(i, j - 1, k, UP)) {
            flag = true;
          }

          if ((j1 == 2) && (!world.isBlockSolidOnSide(i + 1, j, k, UP))) {
            flag = true;
          }

          if ((j1 == 3) && (!world.isBlockSolidOnSide(i - 1, j, k, UP))) {
            flag = true;
          }

          if ((j1 == 4) && (!world.isBlockSolidOnSide(i, j, k - 1, UP))) {
            flag = true;
          }

          if ((j1 == 5) && (!world.isBlockSolidOnSide(i, j, k + 1, UP))) {
            flag = true;
//            if (!world.t(i, j - 1, k)) {
//                flag = true;
//            }
