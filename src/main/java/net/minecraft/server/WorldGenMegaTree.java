            ...
            if (!flag) {
                ...
                if ((i1 == Block.GRASS.id || i1 == Block.DIRT.id) && j < 256 - l - 1) {
                    ...
                    for (j1 = 0; j1 < l; ++j1) {
                        ...
                        if (k1 == 0 || Block.byId[k1] == null || Block.byId[k1].isLeaves(w, i, j + j1, k)) { // Forge
                        ...
                        if (j1 < l - 1) {
                            ...
                            if (k1 == 0 || Block.byId[k1] == null || Block.byId[k1].isLeaves(w, i + 1, j + j1, k)) { // Forge
                            ...
                            if (k1 == 0 || Block.byId[k1] == null || Block.byId[k1].isLeaves(w, i + 1, j + j1, k + 1)) { // Forge
