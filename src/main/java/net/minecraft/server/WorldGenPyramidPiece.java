...
public class WorldGenPyramidPiece extends WorldGenScatteredPiece {
    ...
    public boolean a(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        ChestGenHooks info = ChestGenHooks.getInfo(PYRAMID_DESERT_CHEST); // Forge
        for (var10 = 0; var10 < 4; ++var10)
        {
            if (!this.h[var10])
            {
                ...
                this.h[var10] = this.a(par1World, par3StructureBoundingBox, par2Random, 10 + var11, -11, 10 + var12, info.getItems(par2Random), info.getCount(par2Random)); // Forge
            }
        }
