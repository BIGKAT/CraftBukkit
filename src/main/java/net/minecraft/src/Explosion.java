...
public class Explosion {
    ...
    public Explosion(net.minecraft.src.World world, Entity entity, double d0, double d1, double d2, float f) {
        this.world = world;
        this.source = entity;
                    ...
                    if (damagee == null) {
                        ...
                        if (!event.isCancelled()) {
                            ...
                            if (entity instanceof EntityPlayer) {
                                this.k.put((EntityPlayer) entity, Vec3.a().create(d0 * d10, d1 * d10, d2 * d10));
                            }
                        }
                    } else {
