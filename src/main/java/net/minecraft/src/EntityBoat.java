...
public class EntityBoat extends Entity {
    ...
    public boolean damageEntity(DamageSource damagesource, int i) {
        if (!this.worldObj.isStatic && !this.isDead) {
            ...
            this.K();
            if (damagesource.getEntity() instanceof net.minecraft.src.EntityPlayer && ((net.minecraft.src.EntityPlayer) damagesource.getEntity()).capabilities.canInstantlyBuild) {
                this.setDamage(100);
            }
