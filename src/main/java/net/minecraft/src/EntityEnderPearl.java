...
public class EntityEnderPearl extends EntityProjectile {
    ...
    public EntityEnderPearl(net.minecraft.src.World world) {
        super(world);
    }

    public EntityEnderPearl(net.minecraft.src.World world, net.minecraft.src.EntityLiving entityliving) {
    ...
    protected void a(MovingObjectPosition movingobjectposition) {
        ...
        if (!this.worldObj.isStatic) {
            if (this.shootingEntity != null && this.shootingEntity instanceof EntityPlayerMP) {
                EntityPlayerMP entityplayer = (EntityPlayerMP) this.shootingEntity;
