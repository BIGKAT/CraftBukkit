...
public class EntityLookHelper {
    ...
    private net.minecraft.src.EntityLiving a;
    private float b;
    private float c;
    ...
    public EntityLookHelper(net.minecraft.src.EntityLiving entityliving) {
        this.a = entityliving;
    }

    public void a(net.minecraft.src.Entity entity, float f, float f1) {
        this.e = entity.posX;
