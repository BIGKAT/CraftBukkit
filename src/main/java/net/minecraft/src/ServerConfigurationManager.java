...
public abstract class ServerConfigurationManager {
    ...
    public void a(INetworkManager inetworkmanager, EntityPlayerMP entityplayer) {
        this.a(entityplayer);
        entityplayer.spawnIn(this.server.getWorldServer(entityplayer.dimension));
        entityplayer.itemInWorldManager.a((net.minecraft.src.WorldServer) entityplayer.worldObj);
        String s = "local";
        ...
        net.minecraft.src.WorldServer worldserver = this.server.getWorldServer(entityplayer.dimension);
        ChunkCoordinates chunkcoordinates = worldserver.getSpawn();

        this.a(entityplayer, (EntityPlayerMP) null, worldserver);
    ...
    public void setPlayerFileData(net.minecraft.src.WorldServer[] aworldserver) {
        if (this.playerFileData != null) return; // CraftBukkit
        this.playerFileData = aworldserver[0].getDataManager().getPlayerFileData();
    }

    public void a(EntityPlayerMP entityplayer, net.minecraft.src.WorldServer worldserver) {
        net.minecraft.src.WorldServer worldserver1 = entityplayer.q();
    ...
    protected void b(EntityPlayerMP entityplayer) {
        this.playerFileData.save(entityplayer);
    }

    public void c(EntityPlayerMP entityplayer) {
        ...
        this.a(entityplayer, (net.minecraft.src.WorldServer) null);
        ...
        while (iterator.hasNext()) {
            EntityPlayerMP entityplayer1 = (EntityPlayerMP) iterator.next();
    ...
    public void d(EntityPlayerMP entityplayer) {
    ...
    public String disconnect(EntityPlayerMP entityplayer) { // CraftBukkit - return string
        ...
        this.b(entityplayer);
        net.minecraft.src.WorldServer worldserver = entityplayer.q();
    ...
    public EntityPlayerMP attemptLogin(NetLoginHandler netloginhandler, String s, String hostname) {
        ...
        EntityPlayerMP entity = new EntityPlayerMP(this.server, this.server.getWorldServer(0), s, this.server.L() ? new DemoItemInWorldManager(this.server.getWorldServer(0)) : new ItemInWorldManager(this.server.getWorldServer(0)));
    ...
    public EntityPlayerMP processLogin(EntityPlayerMP player) { // CraftBukkit - String -> EntityPlayerMP
        ...
        return new EntityPlayerMP(this.server, this.server.getWorldServer(0), s, (ItemInWorldManager) object);
        */
        return player;
        // CraftBukkit end
    }
    ...
    // CraftBukkit start
    public EntityPlayerMP moveToWorld(EntityPlayerMP entityplayer, int i, boolean flag) {
    ...
    public EntityPlayerMP moveToWorld(EntityPlayerMP entityplayer, int i, boolean flag, Location location) {
        ...
        if (location == null) {
            ...
            if (cworld != null && chunkcoordinates != null) {
                chunkcoordinates1 = EntityPlayer.getBed(cworld.getHandle(), chunkcoordinates);
        ...
        net.minecraft.src.WorldServer worldserver = ((CraftWorld) location.getWorld()).getHandle();
    ...
    public void changeDimension(EntityPlayerMP entityplayer, int i) {
        // CraftBukkit start -- Replaced the standard handling of portals with a more customised method.
        int dimension = i;
        net.minecraft.src.WorldServer fromWorld = this.server.getWorldServer(entityplayer.dimension);
        net.minecraft.src.WorldServer toWorld = null;
        if (entityplayer.dimension < 10) {
            for (net.minecraft.src.WorldServer world : this.server.worlds) {
    ...
    public void tick() {
        ...
        if (this.o < this.players.size()) {
            EntityPlayerMP entityplayer = (EntityPlayerMP) this.players.get(this.o);
    ...
    public void sendAll(Packet packet) {
        for (int i = 0; i < this.playerEntityList.size(); ++i) {
            ((EntityPlayerMP) this.playerEntityList.get(i)).serverForThisPlayer.sendPacketToPlayer(packet);
        }
    }
    ...
    public EntityPlayerMP f(String s) {
        Iterator iterator = this.playerEntityList.iterator();
    ...
    public void sendPacketNearby(double d0, double d1, double d2, double d3, int i, Packet packet) {
        this.sendPacketNearby((EntityPlayer) null, d0, d1, d2, d3, i, packet);
    }

    public void sendPacketNearby(EntityPlayer entityhuman, double d0, double d1, double d2, double d3, int i, Packet packet) {
        Iterator iterator = this.playerEntityList.iterator();
    ...
    public void b(EntityPlayerMP entityplayer, net.minecraft.src.WorldServer worldserver) {
    ...
    public void updateClient(EntityPlayerMP entityplayer) {
    ...
    private void a(EntityPlayerMP entityplayer, EntityPlayerMP entityplayer1, net.minecraft.src.World world) {
