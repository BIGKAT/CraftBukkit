...
import net.minecraft.server.Vec3DPoolThreadLocal;
...
public class Vec3 {
    ...
    public static Vec3 a(double d0, double d1, double d2) {
        return new Vec3(d0, d1, d2);
    }

    public static Vec3Pool a() {
        return (Vec3Pool) d.get();
    }

    protected Vec3(double d0, double d1, double d2) {
        if (d0 == -0.0D) {
            d0 = 0.0D;
        }
    ...
    protected Vec3 b(double d0, double d1, double d2) {
        this.a = d0;
        this.b = d1;
        this.c = d2;
        return this;
    ...
    public double distanceSquared(Vec3 vec3d) {
        double d0 = vec3d.a - this.a;
        double d1 = vec3d.b - this.b;
        double d2 = vec3d.c - this.c;
    ...
    public Vec3 b(Vec3 vec3d, double d0) {
    ...
    public Vec3 c(Vec3 vec3d, double d0) {
        double d1 = vec3d.a - this.a;
        double d2 = vec3d.b - this.b;
        double d3 = vec3d.c - this.c;
    ...
    public Vec3 d(Vec3 vec3d, double d0) {
        double d1 = vec3d.a - this.a;
        double d2 = vec3d.b - this.b;
        double d3 = vec3d.c - this.c;
