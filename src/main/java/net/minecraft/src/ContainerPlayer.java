...
public class ContainerPlayer extends Container {
    ...
    public net.minecraft.src.InventoryCrafting craftInventory;
    public net.minecraft.src.IInventory resultInventory;
    public boolean g;
    // CraftBukkit start
    ...
    public ContainerPlayer(InventoryPlayer playerinventory) {
        this(playerinventory, true);
    }

    public ContainerPlayer(InventoryPlayer playerinventory, boolean flag) {
        this.resultInventory = new net.minecraft.server.InventoryCraftResult(); // CraftBukkit - moved to before InventoryCrafting construction
        this.craftInventory = new net.minecraft.server.InventoryCrafting(this, 2, 2, playerinventory.player); // CraftBukkit - pass player
        this.craftInventory.resultInventory = this.resultInventory; // CraftBukkit - let InventoryCrafting know about its result slot
        this.player = playerinventory; // CraftBukkit - save player
        this.g = false;
        this.g = flag;
        this.a((net.minecraft.src.Slot) (new SlotResult(playerinventory.player, this.craftInventory, this.resultInventory, 0, 144, 36)));
        ...
        for (i = 0; i < 2; ++i) {
            for (j = 0; j < 2; ++j) {
                this.a(new net.minecraft.src.Slot(this.craftInventory, j + i * 2, 88 + j * 18, 26 + i * 18));
            }
        }

        for (i = 0; i < 4; ++i) {
            this.a((net.minecraft.src.Slot) (new SlotArmor(this, playerinventory, playerinventory.getSize() - 1 - i, 8, 8 + i * 18, i)));
        }

        for (i = 0; i < 3; ++i) {
            for (j = 0; j < 9; ++j) {
                this.a(new net.minecraft.src.Slot(playerinventory, j + (i + 1) * 9, 8 + j * 18, 84 + i * 18));
            }
        }
    ...
    public void a(net.minecraft.src.EntityPlayer entityhuman) {
        ...
        this.resultInventory.setItem(0, (net.minecraft.src.ItemStack) null);
    }
    ...
    public net.minecraft.src.ItemStack b(int i) {
        ...
        if (slot != null && slot.d()) {
            ...
            } else if (itemstack.getItem() instanceof ItemArmor && !((net.minecraft.src.Slot) this.b.get(5 + ((ItemArmor) itemstack.getItem()).a)).d()) {
