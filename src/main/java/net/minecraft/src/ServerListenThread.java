...
public class ServerListenThread extends Thread {
    ...
    public ServerListenThread(ServerConnection serverconnection, InetAddress inetaddress, int i) throws IOException { // CraftBukkit - added throws
        super("Listen thread");
    ...
    public void a() {
        ...
        synchronized (this.b) {
            for (int i = 0; i < this.b.size(); ++i) {
                net.minecraft.src.NetLoginHandler netloginhandler = (net.minecraft.src.NetLoginHandler) this.b.get(i);
    ...
    public void run() {
        while (this.f.b) {
            try {
                ...
                net.minecraft.src.NetLoginHandler netloginhandler = new net.minecraft.src.NetLoginHandler(this.f.d(), socket, "Connection #" + this.d++);
    ...
    private void a(net.minecraft.src.NetLoginHandler netloginhandler) {
