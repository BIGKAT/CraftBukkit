...
public class EntityTracker {
    ...
    public net.minecraft.src.IntHashMap trackedEntities = new net.minecraft.src.IntHashMap(); // CraftBukkit - private -> public
    private int d;

    public EntityTracker(net.minecraft.src.WorldServer worldserver) {
    ...
    public synchronized void updatePlayers() {
        ...
        while (iterator.hasNext()) {
            ...
            if (entitytrackerentry.n && entitytrackerentry.tracker instanceof EntityPlayerMP) {
                arraylist.add((EntityPlayerMP) entitytrackerentry.tracker);
            }
        }
    ...
    // CraftBukkit - synchronized
    public synchronized void a(Entity entity, net.minecraft.src.Packet packet) {
    ...
    // CraftBukkit - synchronized
    public synchronized void sendPacketToEntity(Entity entity, net.minecraft.src.Packet packet) {
        EntityTrackerEntry entitytrackerentry = (EntityTrackerEntry) this.trackedEntities.get(entity.entityId);
    ...
    // CraftBukkit - synchronized
    public synchronized void untrackPlayer(EntityPlayerMP entityplayer) {
        Iterator iterator = this.b.iterator();
