...
public class WorldGenHugeTree extends net.minecraft.src.WorldGenerator implements BlockSapling.TreeGenerator { // CraftBukkit add interface

    private final int a;
    private final int b;
    private final int c;

    public WorldGenHugeTree(boolean flag, int i, int j, int k) {
        super(flag);
        this.a = i;
        this.b = j;
        this.c = k;
