...
public class VillageSiege {
    ...
    public VillageSiege(net.minecraft.src.World world) {
        this.world = world;
    }
        ...
        while (iterator.hasNext()) {
            ...
            if (this.f != null && this.f.getDoorCount() >= 10 && this.f.d() >= 20 && this.f.getPopulationCount() >= 20) {
                ...
                while (true) {
                    ...
                    Vec3 vec3d = this.a(this.g, this.h, this.i);
    ...
    private Vec3 a(int i, int j, int k) {
        for (int l = 0; l < 10; ++l) {
            int i1 = i + this.world.rand.nextInt(16) - 8;
            int j1 = j + this.world.rand.nextInt(6) - 3;
            int k1 = k + this.world.rand.nextInt(16) - 8;

            if (this.f.a(i1, j1, k1) && SpawnerAnimals.a(EnumCreatureType.MONSTER, this.world, i1, j1, k1)) {
                return Vec3.a().create((double) i1, (double) j1, (double) k1);
            }
        }
