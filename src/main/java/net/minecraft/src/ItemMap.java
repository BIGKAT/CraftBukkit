...
public class ItemMap extends ItemMapBase {
    ...
    public MapData getSavedMap(net.minecraft.src.ItemStack itemstack, net.minecraft.src.World world) {

        MapData worldmap = (MapData) world.a(MapData.class, "map_" + itemstack.getData());
        ...
        if (worldmap == null) {
            ...
            worldmap.scale = 3;
            worldmap.map = (byte) ((net.minecraft.src.WorldServer) world).dimension; // CraftBukkit - fixes Bukkit multiworld maps.
            worldmap.a();
    ...
    public void a(net.minecraft.src.World world, Entity entity, MapData worldmap) {
        if (((net.minecraft.src.WorldServer) world).dimension == worldmap.map) { // CraftBukkit
            short short1 = 128;
            short short2 = 128;
    ...
    public void a(net.minecraft.src.ItemStack itemstack, net.minecraft.src.World world, Entity entity, int i, boolean flag) {
        if (!world.isStatic) {
            MapData worldmap = this.getSavedMap(itemstack, world);
    ...
    public void d(net.minecraft.src.ItemStack itemstack, net.minecraft.src.World world, EntityPlayer entityhuman) {
        itemstack.setData(world.b("map"));
        String s = "map_" + itemstack.getData();
    ...
    public net.minecraft.src.Packet c(net.minecraft.src.ItemStack itemstack, net.minecraft.src.World world, EntityPlayer entityhuman) {
