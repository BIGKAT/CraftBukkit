...
public class Chunk {
    ...
    public Chunk(net.minecraft.src.World world, byte[] abyte, int i, int j) {
        this(world, i, j);
        ...
        if (chunksection == null) {
            ...
            if (i1 == l) {
                ...
                if (j1 > 0 && Block.blocksList[j1] instanceof BlockContainer) {
                    net.minecraft.src.TileEntity tileentity = this.e(i, j, k);
    ...
    public void a(net.minecraft.src.Entity entity) {
        this.m = true;
    ...
    public void b(net.minecraft.src.Entity entity) {
        this.a(entity, entity.ai);
    }

    public void a(net.minecraft.src.Entity entity, int i) {
        if (i < 0) {
            i = 0;
        }
    ...
    public net.minecraft.src.TileEntity e(int i, int j, int k) {
        ChunkPosition chunkposition = new ChunkPosition(i, j, k);
        net.minecraft.src.TileEntity tileentity = (net.minecraft.src.TileEntity) this.chunkTileEntityMap.get(chunkposition);
        ...
        if (tileentity == null) {
            ...
            tileentity = (net.minecraft.src.TileEntity) this.chunkTileEntityMap.get(chunkposition);
        }
    ...
    public void a(net.minecraft.src.TileEntity tileentity) {
    ...
    public void a(int i, int j, int k, net.minecraft.src.TileEntity tileentity) {
        ChunkPosition chunkposition = new ChunkPosition(i, j, k);
    ...
    public void f(int i, int j, int k) {
        ...
        if (this.d) {
            net.minecraft.src.TileEntity tileentity = (net.minecraft.src.TileEntity) this.chunkTileEntityMap.remove(chunkposition);
    ...
    public void onChunkUnload() {
        ...
        for (int j = 0; j < i; ++j) {
            ...
            while (iter.hasNext()) {
                net.minecraft.src.Entity entity = (net.minecraft.src.Entity) iter.next();
                int cx = Location.locToBlock(entity.posX) >> 4;
                int cz = Location.locToBlock(entity.posZ) >> 4;

                // Do not pass along players, as doing so can get them stuck outside of time.
                // (which for example disables inventory icon updates and prevents block breaking)
                if (entity instanceof EntityPlayerMP && (cx != this.x || cz != this.z)) {
                    iter.remove();
                }
            }
            // CraftBukkit end
    ...
    public void a(net.minecraft.src.Entity entity, AxisAlignedBB axisalignedbb, List list) {
        ...
        for (int k = i; k <= j; ++k) {
            ...
            while (iterator.hasNext()) {
                net.minecraft.src.Entity entity1 = (net.minecraft.src.Entity) iterator.next();

                if (entity1 != entity && entity1.boundingBox.a(axisalignedbb)) {
                    list.add(entity1);
                    net.minecraft.src.Entity[] aentity = entity1.al();
