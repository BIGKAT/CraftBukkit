...
public class Village {
    ...
    public Village(net.minecraft.src.World world) {
        this.world = world;
    }
    ...
    public void tick(int i) {
        ...
        if (this.j < j && this.doors.size() > 20 && this.world.rand.nextInt(7000) == 0) {
            Vec3 vec3d = this.a(MathHelper.d((float) this.center.x), MathHelper.d((float) this.center.y), MathHelper.d((float) this.center.z), 2, 4, 2);
    ...
    private Vec3 a(int i, int j, int k, int l, int i1, int j1) {
        for (int k1 = 0; k1 < 10; ++k1) {
            ...
            if (this.a(l1, i2, j2) && this.b(l1, i2, j2, l, i1, j1)) {
                return Vec3.a().create((double) l1, (double) i2, (double) j2);
            }
        }
