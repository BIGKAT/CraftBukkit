...
public class BlockSapling extends BlockFlower {
    ...
    public void grow(net.minecraft.src.World world, int i, int j, int k, Random random, boolean bonemeal, org.bukkit.entity.Player player, ItemStack itemstack) {
        ...
        if (l == 1) {
            ...
            for (i1 = 0; i1 >= -1; --i1) {
                for (j1 = 0; j1 >= -1; --j1) {
                    if (this.e(world, i + i1, j, k + j1, 3) && this.e(world, i + i1 + 1, j, k + j1, 3) && this.e(world, i + i1, j, k + j1 + 1, 3) && this.e(world, i + i1 + 1, j, k + j1 + 1, 3)) {
                        ...
                        gen = new WorldGenHugeTree(false, 10 + random.nextInt(20), 3, 3);
                        flag = true;
                        break;
                    }
                }
            ...
            if (gen == null) {
                ...
                gen = new net.minecraft.src.WorldGenTrees(false, 4 + random.nextInt(7), 3, 3, false);
            }
        } else {
            ...
            if (random.nextInt(10) == 0) {
                ...
                gen = new net.minecraft.src.WorldGenBigTree(false);
            }
        }
    ...
    public boolean e(net.minecraft.src.World world, int i, int j, int k, int l) {
    ...
    public interface TreeGenerator {
        ...
        public boolean a(net.minecraft.src.World world, Random random, int i, int j, int k);
