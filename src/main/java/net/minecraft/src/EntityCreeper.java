...
public class EntityCreeper extends EntityMob {
    ...
    public EntityCreeper(net.minecraft.src.World world) {
        ...
        this.goalSelector.a(4, new EntityAIAttackOnCollide(this, 0.25F, false));
        this.goalSelector.a(5, new PathfinderGoalRandomStroll(this, 0.2F));
        this.goalSelector.a(6, new PathfinderGoalLookAtPlayer(this, net.minecraft.src.EntityPlayer.class, 8.0F));
        this.goalSelector.a(6, new PathfinderGoalRandomLookaround(this));
        this.targetSelector.a(1, new PathfinderGoalNearestAttackableTarget(this, EntityPlayer.class, 16.0F, 0, true));
    ...
    public void die(DamageSource damagesource) {
        ...
        if (damagesource.getEntity() instanceof net.minecraft.src.EntitySkeleton) {
