...
import net.minecraft.server.NetworkMasterThread;
import net.minecraft.server.NetworkMonitorThread;
import net.minecraft.server.NetworkReaderThread;
...
public class TcpConnection implements INetworkManager {
    ...
    public TcpConnection(Socket socket, String s, NetHandler nethandler, PrivateKey privatekey) throws IOException { // CraftBukkit - throws IOException
        this.A = privatekey;
        this.socket = socket;
        ...
        this.t = new TcpWriterThread(this, s + " write thread");
        this.u.start();
        this.t.start();
    }
    ...
    public void queue(net.minecraft.src.Packet packet) {
        if (!this.s) {
    ...
    private boolean h() {
        ...
        try {
            ...
            if (this.e == 0 || System.currentTimeMillis() - ((net.minecraft.src.Packet) this.highPriorityQueue.get(0)).timestamp >= (long) this.e) {
                packet = this.a(false);
                if (packet != null) {
                    net.minecraft.src.Packet.a(packet, this.output);
            ...
            if ((flag || this.lowPriorityQueueDelay-- <= 0) && !this.lowPriorityQueue.isEmpty() && (this.highPriorityQueue.isEmpty() || ((net.minecraft.src.Packet) this.highPriorityQueue.get(0)).timestamp > ((net.minecraft.src.Packet) this.lowPriorityQueue.get(0)).timestamp)) {
                packet = this.a(true);
                if (packet != null) {
                    net.minecraft.src.Packet.a(packet, this.output);
                    aint = d;
    ...
    private net.minecraft.src.Packet a(boolean flag) {
        ...
        synchronized (this.h) {
            while (!list.isEmpty() && packet == null) {
                packet = (net.minecraft.src.Packet) list.remove(0);
                this.y -= packet.a() + 1;
    ...
    private boolean a(net.minecraft.src.Packet packet, boolean flag) {
        if (!packet.e()) {
            return false;
        } else {
            List list = flag ? this.lowPriorityQueue : this.highPriorityQueue;
            ...
            do {
                ...
                packet1 = (net.minecraft.src.Packet) iterator.next();
    ...
    private boolean i() {
        ...
        try {
            net.minecraft.src.Packet packet = net.minecraft.src.Packet.a(this.input, this.packetListener.a());
    ...
    public void b() {
        ...
        while (!this.inboundQueue.isEmpty() && i-- >= 0) {
            net.minecraft.src.Packet packet = (net.minecraft.src.Packet) this.inboundQueue.poll(); // CraftBukkit - remove -> poll
    ...
    static boolean a(TcpConnection networkmanager) {
        return networkmanager.m;
    }

    static boolean b(TcpConnection networkmanager) {
        return networkmanager.s;
    }

    static boolean c(TcpConnection networkmanager) {
        return networkmanager.i();
    }

    static boolean d(TcpConnection networkmanager) {
        return networkmanager.h();
    }

    static DataOutputStream e(TcpConnection networkmanager) {
        return networkmanager.output;
    }

    static boolean f(TcpConnection networkmanager) {
        return networkmanager.n;
    }

    static void a(TcpConnection networkmanager, Exception exception) {
        networkmanager.a(exception);
    }

    static Thread g(TcpConnection networkmanager) {
        return networkmanager.u;
    }

    static Thread h(TcpConnection networkmanager) {
