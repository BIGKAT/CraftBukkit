...
public class PlayerManager {
    ...
    public PlayerManager(net.minecraft.src.WorldServer worldserver, int i) {
        if (i > 15) {
    ...
    public net.minecraft.src.WorldServer a() {
        return this.world;
    }
    ...
    public void movePlayer(EntityPlayerMP entityplayer) {
        int i = (int) entityplayer.posX >> 4;
        int j = (int) entityplayer.posZ >> 4;
    ...
    public boolean a(EntityPlayerMP entityplayer, int i, int j) {
    ...
    static net.minecraft.src.WorldServer a(PlayerManager playermanager) {
