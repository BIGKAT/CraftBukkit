...
import net.minecraft.server.CrashReportJVMFlags;
import net.minecraft.server.CrashReportJavaVMVersion;
import net.minecraft.server.CrashReportJavaVersion;
import net.minecraft.server.CrashReportMemory;
import net.minecraft.server.CrashReportOperatingSystem;
