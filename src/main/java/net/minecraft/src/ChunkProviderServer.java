...
public class ChunkProviderServer implements IChunkProvider {
    ...
    public net.minecraft.src.WorldServer world;
    // CraftBukkit end

    public ChunkProviderServer(net.minecraft.src.WorldServer worldserver, IChunkLoader ichunkloader, IChunkProvider ichunkprovider) {
    ...
    public ChunkPosition findNearestMapFeature(net.minecraft.src.World world, String s, int i, int j, int k) {
