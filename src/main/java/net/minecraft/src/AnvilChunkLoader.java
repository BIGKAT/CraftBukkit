...
public class AnvilChunkLoader implements IAsyncChunkSaver, IChunkLoader {
    ...
    public Chunk a(net.minecraft.src.World world, int i, int j) {
    ...
    protected Chunk a(net.minecraft.src.World world, int i, int j, net.minecraft.src.NBTTagCompound nbttagcompound) {
    ...
    public void a(net.minecraft.src.World world, Chunk chunk) {
    ...
    protected void a(ChunkCoordIntPair chunkcoordintpair, net.minecraft.src.NBTTagCompound nbttagcompound) {
        Object object = this.c;
    ...
    public void b(net.minecraft.src.World world, Chunk chunk) {}

    public void a() {}

    public void b() {}

    private void a(Chunk chunk, net.minecraft.src.World world, net.minecraft.src.NBTTagCompound nbttagcompound) {
        ...
        net.minecraft.src.NBTTagCompound nbttagcompound1;
        ...
        if (list != null) {
            ...
            while (iterator1.hasNext()) {
                ...
                net.minecraft.src.NBTTagCompound nbttagcompound2 = new net.minecraft.src.NBTTagCompound();
    ...
    private Chunk a(net.minecraft.src.World world, net.minecraft.src.NBTTagCompound nbttagcompound) {
        ...
        for (int k = 0; k < nbttaglist.size(); ++k) {
            net.minecraft.src.NBTTagCompound nbttagcompound1 = (net.minecraft.src.NBTTagCompound) nbttaglist.get(k);
        ...
        if (nbttaglist1 != null) {
            for (int l = 0; l < nbttaglist1.size(); ++l) {
                net.minecraft.src.NBTTagCompound nbttagcompound2 = (net.minecraft.src.NBTTagCompound) nbttaglist1.get(l);
                net.minecraft.src.Entity entity = EntityTypes.a(nbttagcompound2, world);
        ...
        if (nbttaglist2 != null) {
            for (int i1 = 0; i1 < nbttaglist2.size(); ++i1) {
                net.minecraft.src.NBTTagCompound nbttagcompound3 = (net.minecraft.src.NBTTagCompound) nbttaglist2.get(i1);
                net.minecraft.src.TileEntity tileentity = net.minecraft.src.TileEntity.c(nbttagcompound3);
        ...
        if (nbttagcompound.hasKey("TileTicks")) {
            ...
            if (nbttaglist3 != null) {
                for (int j1 = 0; j1 < nbttaglist3.size(); ++j1) {
                    net.minecraft.src.NBTTagCompound nbttagcompound4 = (net.minecraft.src.NBTTagCompound) nbttaglist3.get(j1);
