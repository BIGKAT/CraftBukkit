...
public class Teleporter {
    ...
    public void a(net.minecraft.src.World world, Entity entity) {
    ...
    public boolean b(net.minecraft.src.World world, Entity entity) {
        short short1 = 128;
        double d0 = -1.0D;
        int i = 0;
        int j = 0;
    ...
    public boolean c(net.minecraft.src.World world, Entity entity) {
        byte b0 = 16;
        double d0 = -1.0D;
        int i = MathHelper.floor(entity.posX);
