...
public class ItemDoor extends Item {
    ...
    public static void place(net.minecraft.src.World world, int i, int j, int k, int l, Block block) {
        // CraftBukkit start
        place(world, i, j, k, l, block, null);
    }

    public static boolean place(net.minecraft.src.World world, int i, int j, int k, int l, Block block, EntityPlayer entityhuman) {
        // CraftBukkit end
        byte b0 = 0;
        byte b1 = 0;
