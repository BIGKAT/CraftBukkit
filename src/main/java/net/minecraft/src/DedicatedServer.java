...
public class DedicatedServer extends MinecraftServer implements IMinecraftServer {
    ...
    public net.minecraft.src.PropertyManager propertyManager; // CraftBukkit - private -> public
    ...
    protected boolean init() throws java.net.UnknownHostException { // CraftBukkit - throws UnknownHostException
        ...
        this.propertyManager = new net.minecraft.src.PropertyManager(this.options); // CraftBukkit - CLI argument support
        if (this.H()) {
            this.e("127.0.0.1");
        } else {
        ...
        this.a((net.minecraft.src.ServerConfigurationManager) (new net.minecraft.src.ServerConfigurationManager(this)));
    ...
    public net.minecraft.src.PropertyManager getPropertyManager() {
    ...
    public net.minecraft.src.ServerConfigurationManager aj() {
        return (net.minecraft.src.ServerConfigurationManager) super.getServerConfigurationManager();
    }
