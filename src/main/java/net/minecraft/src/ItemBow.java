...
public class ItemBow extends Item {
    ...
    public void a(net.minecraft.src.ItemStack itemstack, net.minecraft.src.World world, EntityPlayer entityhuman, int i) {
    ...
    public net.minecraft.src.ItemStack b(net.minecraft.src.ItemStack itemstack, net.minecraft.src.World world, EntityPlayer entityhuman) {
        return itemstack;
    }

    public int a(net.minecraft.src.ItemStack itemstack) {
        return 72000;
    }

    public EnumAnimation b(net.minecraft.src.ItemStack itemstack) {
