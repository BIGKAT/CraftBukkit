...
public final class SpawnerAnimals {
    ...
    protected static ChunkPosition getRandomPosition(net.minecraft.src.World world, int i, int j) {
    ...
    public static final int spawnEntities(net.minecraft.src.WorldServer worldserver, boolean flag, boolean flag1) {
        if (!flag && !flag1) {
            return 0;
        } else {
            b.clear();
            ...
            for (i = 0; i < worldserver.players.size(); ++i) {
                EntityPlayer entityhuman = (EntityPlayer) worldserver.players.get(i);
                                                ...
                                                if (a(enumcreaturetype, worldserver, l2, i3, j3)) {
                                                    ...
                                                    if (worldserver.findNearbyPlayer((double) f, (double) f1, (double) f2, 24.0D) == null) {
                                                        ...
                                                        if (f6 >= 576.0F) {
                                                            ...
                                                            try {
                                                                entityliving = (EntityLiving) biomemeta.b.getConstructor(new Class[] { net.minecraft.src.World.class}).newInstance(new Object[] { worldserver});
    ...
    public static boolean a(EnumCreatureType enumcreaturetype, net.minecraft.src.World world, int i, int j, int k) {
    ...
    private static void a(EntityLiving entityliving, net.minecraft.src.World world, float f, float f1, float f2) {
    ...
    public static void a(net.minecraft.src.World world, BiomeGenBase biomebase, int i, int j, int k, int l, Random random) {
                ...
                for (int j2 = 0; j2 < i1; ++j2) {
                    ...
                    for (int k2 = 0; !flag && k2 < 4; ++k2) {
                        ...
                        if (a(EnumCreatureType.CREATURE, world, j1, l2, k1)) {
                            ...
                            try {
                                entityliving = (EntityLiving) biomemeta.b.getConstructor(new Class[] { net.minecraft.src.World.class}).newInstance(new Object[] { world});
                            } catch (Exception exception) {
                                exception.printStackTrace();
                                continue;
                            }
