...
public abstract class EntityCreature extends EntityLiving
{
    ...
    protected void updateEntityActionState()
    {
        ...
        {
            float var2 = this.entityToAttack.getDistanceToEntity((Entity) this);
        ...
        if (this.pathToEntity != null && this.rand.nextInt(100) != 0)
        {
            ...
            Vec3 var5 = this.pathToEntity.getPosition((Entity) this);
            ...
            while (var5 != null && var5.squareDistanceTo(this.posX, var5.yCoord, this.posZ) < var6 * var6)
            {
                ...
                {
                    var5 = this.pathToEntity.getPosition((Entity) this);
                }
            }
            ...
            if (var5 != null)
            {
                ...
                float var14 = (float)(org.bukkit.craftbukkit.TrigMath.atan2(var10, var8) * 180.0D / 3.1415927410125732D) - 90.0F;
