        ...
        else
        {
            ...
            if (!this.worldObj.isRemote)
            {
                ...
                if (this.fallTime == 1)
                {
                    ...
                    if (this.fallTime != 1 || this.worldObj.getBlockId(var1, var2, var3) != this.blockID || this.worldObj.getBlockMetadata(var1, var2, var3) != this.metadata || CraftEventFactory.callEntityChangeBlockEvent(this, var1, var2, var3, 0, 0).isCancelled())
                    {
                        this.setDead();
                        return;
                    }
