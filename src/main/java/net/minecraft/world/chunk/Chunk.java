...
public class Chunk
{
    ...
    public boolean setBlockIDWithMetadata(int par1, int par2, int par3, int par4, int par5)
    {
        ...
        else
        {
            ...
            if (var10 == null)
            {
                ...
                var10 = this.storageArrays[par2 >> 4] = new ExtendedBlockStorage(par2 >> 4 << 4, !worldObj.provider.hasNoSky);
                var11 = par2 >= var7;
            }
    ...
    public void setLightValue(EnumSkyBlock par1EnumSkyBlock, int par2, int par3, int par4, int par5)
    {
        ...
        if (var6 == null)
        {
            var6 = this.storageArrays[par3 >> 4] = new ExtendedBlockStorage(par3 >> 4 << 4, !worldObj.provider.hasNoSky);
            this.generateSkylightMap();
        }
