...
public class CraftBlock implements Block {
    ...
    public int getBlockPower(BlockFace face) {
        ...
        if ((face == BlockFace.DOWN || face == BlockFace.SELF) && world.isBlockProvidingPowerTo/*was:isBlockFacePowered*/(x, y - 1, z, 0)) power = wire.getMaxCurrentStrength/*was:getPower*/(world, x, y - 1, z, power);
        if ((face == BlockFace.UP || face == BlockFace.SELF) && world.isBlockProvidingPowerTo/*was:isBlockFacePowered*/(x, y + 1, z, 1)) power = wire.getMaxCurrentStrength/*was:getPower*/(world, x, y + 1, z, power);
        if ((face == BlockFace.EAST || face == BlockFace.SELF) && world.isBlockProvidingPowerTo/*was:isBlockFacePowered*/(x + 1, y, z, 2)) power = wire.getMaxCurrentStrength/*was:getPower*/(world, x + 1, y, z, power);
        if ((face == BlockFace.WEST || face == BlockFace.SELF) && world.isBlockProvidingPowerTo/*was:isBlockFacePowered*/(x - 1, y, z, 3)) power = wire.getMaxCurrentStrength/*was:getPower*/(world, x - 1, y, z, power);
        if ((face == BlockFace.NORTH || face == BlockFace.SELF) && world.isBlockProvidingPowerTo/*was:isBlockFacePowered*/(x, y, z - 1, 4)) power = wire.getMaxCurrentStrength/*was:getPower*/(world, x, y, z - 1, power);
        if ((face == BlockFace.SOUTH || face == BlockFace.SELF) && world.isBlockProvidingPowerTo/*was:isBlockFacePowered*/(x, y, z + 1, 5)) power = wire.getMaxCurrentStrength/*was:getPower*/(world, x, y, z - 1, power);
    ...
    static {
        BIOME_MAPPING = new Biome[net.minecraft.world.biome.BiomeGenBase/*was:BiomeBase*/.biomeList/*was:biomes*/.length];
