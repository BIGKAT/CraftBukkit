...
public class CustomChunkGenerator extends InternalChunkGenerator {
    ...
    public List getPossibleCreatures/*was:getMobsFor*/(net.minecraft.entity.EnumCreatureType/*was:EnumCreatureType*/ type, int x, int y, int z) { // CBMCP - return type List<?> -> List for matching remap
