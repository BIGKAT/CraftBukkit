...
public class MinecraftForge
{
    ...
    public static void setToolClass(Item tool, String toolClass, int harvestLevel)
    {
        ...
        ForgeHooks.toolClasses.put(tool.id, Arrays.asList(toolClass, harvestLevel));
    }
    ...
    {
        ForgeHooks.initTools();
        List key = Arrays.asList(block.id, metadata, toolClass);
    ...
    static
    {
        ...
        addDungeonLoot(new ItemStack(Item.IRON_INGOT),      1.00f, 1, 4);
        addDungeonLoot(new ItemStack(Item.BREAD),           1.00f      );
        addDungeonLoot(new ItemStack(Item.WHEAT),           1.00f, 1, 4);
        addDungeonLoot(new ItemStack(Item.SULPHUR),         1.00f, 1, 4);
        addDungeonLoot(new ItemStack(Item.STRING),          1.00f, 1, 4);
        addDungeonLoot(new ItemStack(Item.BUCKET),          1.00f      );
        ...
        addDungeonLoot(new ItemStack(Item.INK_SACK, 1, 3),  1.00f      );
