...
public class EnumHelper
{
    ...
    public static org.bukkit.World.Environment addBukkitEnvironment(int id, String name)
    {
        ...
        return addEnum(decompiledFlags[0], org.bukkit.World.Environment .class, name,
                new Class[] {int.class},
                new Object[]{ id });
    }
    public static EnumAnimation addAction(String name)
    {
        ...
        return addEnum(decompiledFlags[0], EnumAnimation.class, name,
                new Class[] {},
                new Object[]{});
    }
    ...
    public static MonsterType addCreatureAttribute(String name)
    {
        if (!isSetup)
        {
            setup();
        ...
        return addEnum(decompiledFlags[3], MonsterType.class, name,
                new Class[] {},
                new Object[]{});
    }
    ...
    public static WorldGenStrongholdDoorType addDoor(String name)
    {
        ...
        return addEnum(decompiledFlags[5], WorldGenStrongholdDoorType.class, name,
                new Class[] {},
                new Object[]{});
    }
    public static EnchantmentSlotType addEnchantmentType(String name)
    {
        ...
        return addEnum(decompiledFlags[6], EnchantmentSlotType.class, name,
                new Class[] {},
                new Object[]{});
    }
    ...
    public static EnumBedResult addStatus(String name)
    {
        ...
        return addEnum(decompiledFlags[10], EnumBedResult.class, name,
                new Class[] {},
                new Object[]{});
    }
