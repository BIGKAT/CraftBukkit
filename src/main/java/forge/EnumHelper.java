...
public class EnumHelper
{
    ...
    public static EnumAnimation addAction(String name)
    {
        ...
        return addEnum(decompiled[0], EnumAnimation.class, name,
                new Class[] {},
                new Object[]{});
    }
    ...
    public static MonsterType addCreatureAttribute(String name)
    {
        ...
        return addEnum(decompiled[3], MonsterType.class, name,
                new Class[] {},
                new Object[]{});
    }
    ...
    public static WorldGenStrongholdDoorType addDoor(String name)
    {
        ...
        return addEnum(decompiled[5], WorldGenStrongholdDoorType.class, name,
                new Class[] {},
                new Object[]{});
    }
    public static EnchantmentSlotType addEnchantmentType(String name)
    {
        ...
        return addEnum(decompiled[6], EnchantmentSlotType.class, name,
                new Class[] {},
                new Object[]{});
    }
    ...
    public static EnumBedResult addStatus(String name)
    {
        ...
        return addEnum(decompiled[10], EnumBedResult.class, name,
                new Class[] {},
                new Object[]{});
    }
